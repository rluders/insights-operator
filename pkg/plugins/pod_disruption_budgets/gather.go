...
func (p *plugin) Gather(ctx context.Context, kubeConfig *rest.Config) func() ([]record.Record, []error) {
	return func() ([]record.Record, []error) {
		gatherPolicyClient, err := policyclient.NewForConfig(kubeConfig)
		if err != nil {
			return nil, []error{err}
		}
		return p.podDisruptionBudgets(ctx, gatherPolicyClient)
	}
}

func (p *plugin) podDisruptionBudgets(ctx context.Context, policyClient policyclient.PolicyV1beta1Interface) ([]record.Record, []error) {
